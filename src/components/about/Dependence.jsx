    ...
    render() {
        return (
            <div className="container-fluid pt-2 pb-2 based-on">
                ...
                <div className="row justify-content-center">
                    <div className="col col-auto">
                        <a className="link-box text-dark" href="https://www.xuzhouplus.com.cn/eat.html" target="_blank" ref="noopener noreferrer external nofollow">
                            <span className="eat-span">?</span>
                            吃什么？
                        </a>
                    </div>
                    <div className="col col-auto">
                        <a className="link-box text-dark" href="https://www.xuzhouplus.com.cn/resume/index.html" target="_blank" ref="noopener noreferrer external nofollow">
