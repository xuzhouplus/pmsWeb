                ...
                <Card.Body>
                    <Form className="post-profile-form" onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group className="position-relative mt-3">
                            ...
                            <Form.Control id="input-title" aria-describedby="title-text" type='text' defaultValue={this.state.title.value} isInvalid={this.state.title.isInvalid} isValid={this.state.title.isValid} onChange={this.onChange} onBlur={this.onChange}/>
                        ...
                        <Form.Group className="position-relative mt-3">
                            ...
                            <Form.Control id="input-sub-title" aria-describedby="sub-title-text" type='text' defaultValue={this.state.subTitle.value} isInvalid={this.state.subTitle.isInvalid} isValid={this.state.subTitle.isValid} onChange={this.onChange} onBlur={this.onChange}/>
                            <Form.Control.Feedback type="invalid" tooltip>
