...
const Utils = {
	...
	updateCarousel: function (data, callback, fallback) {
		return this.http('post', configs.proxyBackendHost + configs.updateCarouselUrl, data, callback, fallback)
	},
	...
	http: function (type, url, query, data, callback, fallback) {
	...
	setCarouselCaptionStyle: function (id, field, styles, callback, fallback) {
		return this.http('post', configs.proxyBackendHost + configs.setCarouselCaptionStyleUrl, {
			id: id,
			field: field
		}, styles, callback, fallback);
	}
}
